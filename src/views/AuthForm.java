            ...
            if(cedula.length() == 10){
                if(telefono.length() == 10){
                    if(password.length() >= 8){
                        ...
                        if(mather.find()){
                            return new ValidarResponse(true,"El usuario se registro correctamente");
                        }else{
                            return new ValidarResponse(false,"El email no es valido");
                        }
                    }else{
                        return new ValidarResponse(false,"La contraseña debe contener almenos 8 caracteres");
                    }
                }else{
                    return new ValidarResponse(false,"El telefono no es válido");
                }
            }else{
                return new ValidarResponse(false,"La cédula debe contener 10 digitos");
            }
        }else{
            return new ValidarResponse(false,"Es necesaro rellenar todos los campos");
        }
    }
}
